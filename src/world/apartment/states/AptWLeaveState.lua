...
AptWLeaveState = Class{__includes = BaseState}

function AptWLeaveState:init(nextGameState)
    self.apartment = gGlobalObjs['apartment']
    self.player = gGlobalObjs['player']
    self.nextGameState = nextGameState
end

function AptWLeaveState:enter()
    self:tweenLeave()
end

function AptWLeaveState:tweenLeave()
...
function AptWLeaveState:update(dt)
    self.player:update(dt)
end

function AptWLeaveState:render()
