...
function WorkGInstructionsState:enter()
    gStateStack:push(DialogueState(
        ...
        'Try and get 10 of your reports past the SEC representative before he gets '..
        '10 past you using the up and down arrow keys to block the reports from getting through.',
        -- Callback arg
        function()
