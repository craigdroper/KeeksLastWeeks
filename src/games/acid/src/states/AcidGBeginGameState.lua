...
AcidGBeginGameState = Class{__includes = BaseState}
...
function AcidGBeginGameState:enter()
    -- initialize a new board according to the current level
    -- this will later be passed to the play state
...
function AcidGBeginGameState:update(dt)
