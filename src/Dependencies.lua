...
gWeedGSounds = {
    ...
    ['powerup_smoking'] = love.audio.newSource('src/games/weed/sounds/powerup_smoking.mp3'),
    ['hit'] = love.audio.newSource('src/games/weed/sounds/hit.wav'),
    ['hit_smoking'] = love.audio.newSource('src/games/weed/sounds/hit_smoking.mp3'),
    ['miss_smoking'] = love.audio.newSource('src/games/weed/sounds/miss_smoking.mp3'),
