...
WeedGBattleMessageState = Class{__includes = BaseState}

function WeedGBattleMessageState:init(msg, onClose, canInput)
...
function WeedGBattleMessageState:update(dt)
...
function WeedGBattleMessageState:render()
    self.textbox:render()
end
