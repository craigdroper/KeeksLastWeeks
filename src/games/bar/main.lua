...
function love.load()
    ...
    gBGSounds['music']:play()
    gBGSounds['music']:setLooping(true)
...
function love.draw()
    ...
    -- virtual resolution
    local backgroundWidth = gBGTextures['background']:getWidth()
    local backgroundHeight = gBGTextures['background']:getHeight()

    love.graphics.draw(gBGTextures['background'], 
...
function renderHealth(health)
    ...
    -- render health left
    for i = 1, health do
        love.graphics.draw(gBGTextures['hearts'], gBGFrames['hearts'][1], healthX, 4)
        healthX = healthX + 11
    end

    -- render missing health
    for i = 1, 3 - health do
        love.graphics.draw(gBGTextures['hearts'], gBGFrames['hearts'][2], healthX, 4)
        healthX = healthX + 11
    end
end
