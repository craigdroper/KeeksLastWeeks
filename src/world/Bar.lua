...
function Room:init(player)
    ...
    self.entities = {}
    -- No entities in dev version of KLW room self:generateEntities()

    -- game objects in the room
    self.objects = {}
    -- No objects in dev version of KLW skeleton code self:generateObjects()
    ...
    -- reference to keeks for collisions, etc.
    self.player = player
