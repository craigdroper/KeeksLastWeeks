...
function CasGInstructionsState:enter()
    gStateStack:push(DialogueState(
        ...
        'You are playing 1-1 against the dealer, each attempting to get as close to 21 '..
        'as possible without going over.\n'..
        'Ties go to the dealer, and the dealer must hit on 16 or less and stay on 17 or greater.\n'..
